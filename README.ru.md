...
1.  Установите [Bun](https://bun.sh/), если его ещё нет в вашей системе. Рекомендуемая версия Bun - не ниже 1.1.21
...
Флаги:
  ...
  * `-i` проверяет и исправляет абсолютный путь импорта к funcs.ts в текущем файле рецептов 
        и во всех файлах рецептов, расположенных в текущем и в дочерних каталогах
...
У основной функции Bun Shell `$` нет опции предварительного вывода в консоль 
